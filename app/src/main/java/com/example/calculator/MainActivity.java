...
public class MainActivity extends AppCompatActivity {
    ...
    private Button b1,b2,b3,b4,b5,b6,b7,b8,b9,b0,b_add,b_sub,b_mul,b_div,b_eql,b_pnt,reset,log,sqrt,pwr;
    private boolean add,sub,mul,div,sqt,powr;
    private double value1,value2,result,nu1,nu2;
    String val;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pwr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nu1= Double.parseDouble(et.getText().toString());
                powr = true;
                et.setText("");
            }
        });
        ...
        b_eql.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (add == true){
                    ...
                    nu2 = Double.parseDouble(et.getText().toString());
                    int pw = (int)Math.pow(nu1,nu2);
                    et.setText(String.valueOf(pw));
                    textView.setText(String.valueOf(nu1+"^"+nu2));
                }
                add= sub = mul = div= sqt= powr= false;
            }
        });
